...
- 🔭 **Focus:** Architecting end-to-end web applications with robust backends and reactive frontends.
- 🛠️ **Current Work:** Developing full-stack web platforms and desktop productivity utilities.
- ⚡ **Core Strengths:** Database schema design, RESTful APIs, modern frontend components, and deployment management.
